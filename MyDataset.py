...
class Data_DG_harf1(Dataset):
    def __init__(self, root_dir, dataName, STMap, frames_num, args, transform=None, domain_label=None):
        ...
        self.datalist = self.datalist[:int(self.num / 2)]
    ...
    def __getitem__(self, idx):
        ...
        # nowPath = nowPath.replace('haolu', 'jywang')
        ...
        if self.domain_label is not None:
            return (map_ori, bvp, gt, map_aug, bvp_aug, gt_aug, self.domain_label)
        else:
